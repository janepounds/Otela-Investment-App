...
class StokvelCongratulationsScreen extends StatefulWidget {
  ...
  _StokvelCongratulationsScreenState createState() =>
      _StokvelCongratulationsScreenState();
}

class _StokvelCongratulationsScreenState
    extends State<StokvelCongratulationsScreen> {
  String userName = '';
  String stokvel = '';
